...
<footer class="px-3 py-8 text-gray-500 transition-colors duration-200 bg-white">
    <div class="flex flex-col">
        ...
        <div class="flex flex-col mt-4 md:mt-0 md:flex-row">
            ...
            <div class="flex items-center justify-center flex-1 mt-4 border-gray-100 md:mt-0 md:border-r">
                <a class="hover:text-primary-gray-20" href="https://github.com/vbhvshukla/codaborator/">
                    <span class="sr-only">
                        View on GitHub
                    </span>
            ...
            <div class="flex flex-col items-center justify-center flex-1 mt-7 md:mt-0 md:items-start md:pl-5">
                ...
                <span class="mt-7 md:mt-1">
                    Created by &nbsp;
                    <a class="underline hover:text-primary-gray-20" href="https://www.linkedin.com/in/vaibhav-shukla-iitm/">
                         Vaibhav
                    </a>
                </span>
            </div>
